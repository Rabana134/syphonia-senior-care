...
if (isset($_GET['action']) && $_GET['action'] === 'logout') {
    ...
    if (!wp_verify_nonce($nonce, 'pg-logout')) {
        die(__('Security check failed','profilegrid-user-profiles-groups-and-communities'));
    }
...
if ( is_user_logged_in()) : 
 ...
 <div class="pg-user-content pm-dbfl pm-border">
     ...
     if (is_user_logged_in())
       ...
       ?>
     <div class="pg_widget_logout_link pm-dbfl pm-border pm-pad10"><a href="<?php echo esc_url($login_page_url_widget); ?>/?action=logout&_wpnonce=<?php echo wp_create_nonce('pg-logout');?>"><?php esc_html_e('Logout','profilegrid-user-profiles-groups-and-communities');?></a></div>
