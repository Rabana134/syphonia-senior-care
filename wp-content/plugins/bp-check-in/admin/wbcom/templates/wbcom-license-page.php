	...
	<div class="wbcom-wrap wbcom-plugin-wrapper">
		<div class="wbcom_admin_header-wrapper">
			<div id="wb_admin_plugin_name">
				...
				<span><?php printf( __( 'Version %s', 'bp-checkins' ), BPCHK_PLUGIN_VERSION ); ?></span>
			</div>
			<?php echo do_shortcode( '[wbcom_admin_setting_header]' ); ?>
		</div>
		<div class="wbcom-all-addons-plugins-wrap">
		<h4 class="wbcom-support-section"><?php esc_html_e( 'Plugin License', 'bp-checkins' ); ?></h4>
		<div class="wb-plugins-license-tables-wrap">
			...
			<table class="form-table wb-license-form-table desktop-license-headings">
				<thead>
					<tr>
						<th class="wb-product-th"><?php esc_html_e( 'Product', 'bp-checkins' ); ?></th>
						<th class="wb-version-th"><?php esc_html_e( 'Version', 'bp-checkins' ); ?></th>
						<th class="wb-key-th"><?php esc_html_e( 'Key', 'bp-checkins' ); ?></th>
						<th class="wb-status-th"><?php esc_html_e( 'Status', 'bp-checkins' ); ?></th>
						<th class="wb-action-th"><?php esc_html_e( 'Action', 'bp-checkins' ); ?></th>
					</tr>
				</thead>
			</table>
