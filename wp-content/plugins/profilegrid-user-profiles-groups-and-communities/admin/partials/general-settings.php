        ...
        <div class="uimrow">
            ...
            <div class="uiminput">
                ...
                <select name="pm_date_format" id="pm_date_format">
                    <option value="Y-m-d" <?php selected( 'Y-m-d', $pm_date_format ); ?>><?php echo date('Y-m-d').'( Y-m-d )'; ?></option>
                    <option value="d-m-Y"  <?php selected( 'd-m-Y', $pm_date_format ); ?>><?php echo date('d-m-Y').'( d-m-Y )'; ?></option>
                    <option value="m-d-Y"  <?php selected( 'm-d-Y', $pm_date_format ); ?>><?php echo date('m-d-Y').'( m-d-Y )'; ?></option>
